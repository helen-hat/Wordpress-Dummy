...
class Banner_V4 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Banner V4', 'sinco' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'banner_v4',
            [
                'label' => esc_html__( 'Banner V4', 'sinco' ),
            ]
        );
		$this->add_control(
			'title',
	...
	<div class="hero-banner-three">
		<div class="container">
			<div class="row">
				<div class="col-xl-7 col-md-6">
					...
					<?php if($settings['text']) { ?><p class="text-lg mb-50 lg-mb-40"><?php echo wp_kses($settings['text'], true); ?></p><?php } ?>
	    ...
	    <div class="illustration-holder sm-mt-50">
			<img src="<?php echo esc_url(wp_get_attachment_url($settings['banner_image']['id'])); ?>" alt="<?php esc_attr_e('Awesome Image', 'sinco'); ?>" class="main-illustration transform-img-meta ms-auto">
			<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape_19.png" alt="<?php esc_attr_e('Awesome Image', 'sinco'); ?>" class="shapes shape-one">
		</div> <!-- /.illustration-holder -->
		<?php } ?>
		<?php if($settings['pattern_image']) { ?>
		<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape_18.svg" alt="<?php esc_attr_e('Awesome Image', 'sinco'); ?>" class="shapes cube-shape">
		<?php } ?>
