...
class Services_V1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Services v1', 'sinco' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'services_v1',
			[
				'label' => esc_html__( 'Services V1', 'sinco' ),
			]
		);
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			'service_description',
			[
				'label'       => __( 'Service Description', 'sinco' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Service Description', 'sinco' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	============================================== 
	-->
	<div class="fancy-feature-four position-relative mt-110 lg-mt-50">
		<div class="bg-wrapper">
			<div class="inner-container">
				<div class="container">
					<div class="row gx-xxl-5">
						<?php if($settings['subtitle'] || $settings['title'] || $settings['service_description']) { ?>
                        <div class="col-lg-4 mt-40 d-flex" data-aos="fade-up">
							<div class="d-flex justify-content-center flex-column">
								...
								<div><div class="btn-three rev mt-35 lg-mt-20"><?php echo wp_kses($settings['service_description'], true);?></div></div>
								<?php } ?>
							</div>
						</div>
                        <?php } ?>
		...
		<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape_06.svg" alt="<?php esc_attr_e('Awesome Image', 'sinco'); ?>" class="shapes shape-one">
		<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/shape/shape_07.svg" alt="<?php esc_attr_e('Awesome Image', 'sinco'); ?>" class="shapes shape-two">
		<?php } ?>
