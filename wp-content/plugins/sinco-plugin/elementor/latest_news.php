...
class Latest_News extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News', 'sinco' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news',
			[
				'label' => esc_html__( 'Latest News', 'sinco' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	=====================================================
	-->
	<div class="<?php if($settings['style_two'] == 'two') echo 'blog-section-three position-relative pt-70 lg-pt-40'; else echo 'blog-section-one pt-100 pb-140 lg-pt-80 lg-pb-80'; ?> ">
		<div class="container">
			<?php if($settings['subtitle'] || $settings['title']) { ?>
			<div class="<?php if($settings['style_two'] == 'two') echo 'title-style-three'; else echo 'title-style-one'; ?> text-center mb-50 lg-mb-20" data-aos="fade-up">
			...
			<div class="row gx-xxl-5">
				...
				<div class="col-lg-4 col-sm-6 d-flex" data-aos="fade-up">
					<article class="blog-meta-one color-two tran3s mt-30">
						<figure class="post-img m0"><a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>" class="w-100 d-block"><div class="w-100 tran4s"><?php the_post_thumbnail('sinco_410x320'); ?></div></a></figure>
						<div class="post-data">
							<div class="post-tag"><?php the_category(' '); ?></div>
