			...
			<div class="bg-wrapper">
				<div class="row align-items-center">
					...
					<div class="col-lg-8 text-center text-lg-start">
						<p class= "par">Don’t see a role that fits? We are growing rapidly and always on the lookout for passionate and smart engineers! If you are passionate about your career, send us your profile.</p>
					</div>
					<?php } ?>
