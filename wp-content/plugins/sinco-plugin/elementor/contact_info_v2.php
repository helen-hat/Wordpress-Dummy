...
class Contact_Info_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Contact Info V2', 'sinco' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'contact_info_v2',
            [
                'label' => esc_html__( 'Contact Info V2', 'sinco' ),
            ]
        );
		$this->add_control(
			'style',
		...
		$this->add_control(
			...
			'fields' => 
				[
					...
					[
						'name' => 'style_two',
						'label'       => __( 'Enable/Disable Right Side Border', 'sinco' ),
    ...
    <div class="address-section-one">
        <div class="container">
            <div class="inner-content <?php if($settings['style'] == 'two') echo 'color-one'; else echo 'bg-white' ?>" data-aos="fade-up">
                <div class="row g-0">
                    <?php foreach($settings['info'] as $key => $item): ?>
                    <div class="col-md-6 d-flex">
                        <div class="address-block-one d-flex <?php if($item['style_two']) echo 'border-right'; ?>">
