...
class Latest_News_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News V3', 'sinco' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v3',
			[
				'label' => esc_html__( 'Latest News V3', 'sinco' ),
			]
		);
		$this->add_control(
			'subtitle',
    ...
    <div class="blog-section-two mt-140 lg-mt-100">
        <div class="container">
            ...
            <div class="row gx-xxl-5">
                ...
                <div class="<?php if(get_post_meta( get_the_id(), 'dimension', true) == 'extra_height') echo 'col-lg-4 col-sm-6'; else echo 'col-lg-4 col-sm-6'?> d-flex" data-aos="fade-up">
