 ...
 * @since 1.0.0
 */
class Our_Business_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Our Business V2', 'sinco' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'our_business_v2',
            [
                'label' => esc_html__( 'Our Business V2', 'sinco' ),
            ]
        );
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			...
			[
				'label'       => __( 'Business Description', 'sinco' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your business description', 'sinco' ),
			]
		);
		$this->add_control(
			'business_image',
			...
			<div class="row">
				<div class="col-xxl-5 col-lg-6 col-md-7 ms-auto">
					<div class="block-style-two" data-aos="fade-left">
						...
						<?php if($settings['business_description']) { ?>
						<div class="btn-three rev mt-55 lg-mt-30"><?php echo wp_kses($settings['business_description'], true);?></div>
						<?php } ?>
					</div> <!-- /.block-style-two -->
				</div>
			</div>
