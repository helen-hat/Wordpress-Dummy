...
class Blog_Grid extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog Grid', 'sinco' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'blog_grid',
			[
				'label' => esc_html__( 'Blog Grid', 'sinco' ),
			]
		);
		$this->add_control(
			'text_limit',
    ...
    <div class="blog-section-three pt-90 mb-150 lg-pt-40 lg-mb-100">
        <div class="container">
            ...
            <div class="page-pagination-one pt-90">
                <div class="d-flex align-items-center justify-content-center style-none">
